const ej22 = /*html*/`
<h1>Ejercicio 2.2</h1>
<h2>Implementacion en cada arreglo metodo buburja mejorada</h2>
    ...
    <script type="text/x-c++src">
        class Ej2BurbujaMejorada {
            ...
            public static void main(String[] args) {
                ...
                int comp = improvBubbleSort(Nombres);
...
<div id=div_img_res>
    <h5>Resultado</h5>
    <img src="imgs/ej22A.png" id="img_res">
</div>
