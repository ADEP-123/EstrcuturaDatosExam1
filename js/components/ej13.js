const ej13 = /*html*/`
<h1>Ejercicio 1.3</h1>
<h2>Analisis de precio del dolar en 2022 con metodo quick sort</h2>
...
<pre class="code-container">
    ...
    <script type="text/x-c++src">
        class quickSortEj1 {
            ...
            public static int quickSort(double arr[], int inicio, int fin, String[] arr2) {
                int comparaciones = 0;
                if (inicio >= fin) {
                ...
                while (elemIzq <= elemDer) {
                    ...
                    if (elemIzq < elemDer) {
                        ...
                        String temp2 = arr2[elemIzq];
                        arr2[elemIzq] = arr2[elemDer];
                        arr2[elemDer] = temp2;
                    }
                }
                ...
                if (elemDer > inicio) {
                    ...
                    String temp2 = arr2[elemDer];
                    arr2[elemDer] = arr2[inicio];
                    arr2[inicio] = temp2;
                }
                quickSort(arr, inicio, elemDer - 1, arr2);
                quickSort(arr, elemDer + 1, fin, arr2);
                return comparaciones;
            }
            ...
            public static void main(String[] args) {
                ...
                int comp = quickSort(valores, 0, valores.length - 1, fechas);
...
<div id=div_img_res>
    <h5>Resultado</h5>
    <img src="imgs/ej13A.png" id="img_res">
    <img src="imgs/ej13b.png" id="img_res">
    <img src="imgs/ej13C.png" id="img_res">
</div>
